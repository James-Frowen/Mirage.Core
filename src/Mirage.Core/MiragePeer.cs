...
namespace Mirage
{
    ...
    {
        public readonly MetricSettings MetricsSettings;
        /// <summary>
        ...
        /// </summary>
        public readonly bool DisconnectOnException = true;
        /// <summary>
        ...
        /// </summary>
        public readonly bool RethrowException = false;
        ...
        public MiragePeer(bool disconnectOnException = true, bool rethrowException = false, Config peerConfig = null, MetricSettings metric = null)
        {
            GeneratedCode.Init();
